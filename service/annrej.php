...
<body id="page-top">
  <div id="wrapper">
    ...
    while($row = mysqli_fetch_array($result)){
      ...
      <input class="btn btn-warning"  type="submit" style="margin-top:10%;margin-left:31%" value="Completer" name="edit">
      <input  class="btn btn-danger" type="submit" style="margin-top:10%" value="Supprimer" name="supprimer">
      </form>';
      echo '</div>';
      echo '</div>';
      echo '</div>';
