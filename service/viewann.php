...
<body id="page-top">
  <div id="wrapper">
    ...
    while($row = mysqli_fetch_array($result)){
      ...
      <div class="card border-info" style="margin-top:5%;margin-bottom:3%;">';
      ...
      <input class="btn btn-warning"  type="submit" style="margin-top:10%;margin-left:31%" value="Modifier" name="edit">
      <input  class="btn btn-danger" type="submit" style="margin-top:10%" onclick="return confirm(\'Tu es sure tu veux supprimer cet annonce?\');" value="Supprimer" name="supprimer">
      </form>';
      echo '</div>';
      echo '</div>';
      echo '</div>';
