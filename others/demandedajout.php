...
<head>
  ...
  <title>MadinaTech - Demandes D'Inscription</title>
...
<body id="page-top">
  <div id="wrapper">
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background: linear-gradient( #008BFF,#219AFF,#4FAFFF, #6EBDFF);">
      ...
      <li class="nav-item active"><a class="nav-link" href="demandedajout.php"><i class="fas fa-vote-yea"></i><span>&#160;Demandes d'inscription</span></a></li>
   ...
   while($row = mysqli_fetch_array($result)){
     ...
     <input class="btn btn-success" type="submit" value="Valider" name="accepter">
 ...
 if(isset($_POST['accepter'])){
     ...
     $exec_requete = mysqli_query($db,$requete);
      ...
      require_once(dirname(__FILE__) . "/PHPMailer-5.2.28/class.phpmailer.php");
         ...
         $mail ->Subject  = "NOTICE";
         $mail ->Body = "Votre demande d'inscription a été approuvé, bienvenue dans notre communauté. \n Connectez vous maintenant http://127.0.0.1/site/log.php.";
 ...
 if(isset($_POST['supprimer'])){
     ...
     require_once(dirname(__FILE__) . "/PHPMailer-5.2.28/class.phpmailer.php");
               ...
               $mail ->SetFrom("amadinatec@gmail.com");
               $mail ->Subject  = "NOTICE";
               $mail ->Body = "Votre demande d'inscription a été rejeté.";
               $mail ->AddAddress($mailto);
               $mail->SMTPOptions = array('ssl' => array(
                 'verify_peer' => false,
                 'verify_peer_name' => false,
