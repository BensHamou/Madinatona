...
if(isset($_POST['pass'])) {
  ...
  if($count!=0){
    ...
    if($qry){
      ...
      if( $_SESSION['type']==0 ){print("<script type=\"text/javascript\">location.href=\"homecit.php\"</script>");}
  ...
  if(isset($_POST['delete'])) {
    ...
    if($count!=0){
      ...
      if($qry){
        ...
        $message = "Mot de pass inccorect.";
        echo "<script type='text/javascript'>alert('$message');</script>";
        if( $_SESSION['type']==0 ){print("<script type=\"text/javascript\">location.href=\"deleteacc.php\"</script>");}
      }
    }
  ?>
