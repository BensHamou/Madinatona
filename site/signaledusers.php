...
<head>
  <meta charset="utf-8">
  <title>MadinaTech - List Signalé</title>
...
<ul>
  ...
  <div class="dropdown">
    <li><a class="active">List (Signalés)</a></li>
...
<body id='grad1'>
  <form class="search" action="searchsignaled.php">
    <input type="submit" value="trouver un utilisateur ?" />
  </form>
  <?php
  $db_username = 'root';
  $db_password = '';
  ...
  while($row = mysqli_fetch_array($result)){
    ...
    echo  '<p class="adress">Signalé ' . $row['signaled'] . ' fois</p>';
...
if(isset($_POST['supprimer'])){
    ...
    $mail ->Subject  = "NOTICE";
    $mail ->Body = "SORRY YOUR ACCOUNT HAS BEEN DELETED for non respect of our policy";
