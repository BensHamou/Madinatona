                     ...
                     <div class="menu">
                       <ul class="clearfix nav nav-tabs">
                         <li><a class="nav-link" href="wreport.php">Ecrire</a></li>
                          ...
                          <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="#">Téléphone</a>
                          <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="oonprogress.php">Désactiver compte</a>
