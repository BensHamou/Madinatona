...
<html>
<head>
    <title>MadinaTech - Actualités</title>
...
<body id="default_theme" class="services" style="background-color: C9FFE5;">
                 ...
                 <div class="menu" style="background-color: C9FFE5;">
                   <ul class="clearfix nav nav-tabs">
                        ...
                        <div class="dropdown-menu">
                         ...
                         <li><a class="nav-link active" style="background-color:LightBlue" href="viewacc.php">Actualités</a></li>
    ...
    $result = mysqli_query($db,"SELECT * FROM signalement where signalement.visible=2 order by date1 desc");
    while($row = mysqli_fetch_array($result)){
      ...
      if($row['etat']==1){
        ...
        echo  '<p5 class="adress" style="color:orange;margin-left:auto;margin-right:auto;">Signalement en cours de réparation.</p>';
      }
      else if($row['etat']==3){
