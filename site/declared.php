...
<head>
  <meta charset="utf-8">
  <title>MadinaTech - Signalements declaré</title>
...
<ul>
  ...
  <li><a class="active" href="declared.php">Consulter les nouveaux signalements</a></li>
...
<body id='grad1'>
  <form action="treatreport.php" method="POST">
    ...
    $result = mysqli_query($db,"SELECT * FROM signalement where signalement.type = '".$type."' and signalement.etat = 1 and signalement.visible=2 ORDER by priority desc, date1 desc");
