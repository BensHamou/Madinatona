...
<head>
    <meta charset="utf-8">
    <title>MadinaTech - Reports Finished</title>
  ...
  <ul>
    ...
    <li><a class="active" href="finished.php">Consulter les signalements terminé</a></li>
...
<body id='grad1'>
  <form action="treatreport.php" method="POST">
    ...
    $result = mysqli_query($db,"SELECT * FROM signalement where signalement.type = '".$type."' and signalement.etat = 3 and signalement.visible=2 ORDER by priority desc, date1 desc");
    while($row = mysqli_fetch_array($result)){
      ...
      echo  '<p class="username">Signalement cloturé.</p>';
      echo '</div>';
    }
    ?>
  </form>
