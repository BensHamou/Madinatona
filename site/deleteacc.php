        ...
        <div class="container">
           <div class="row">
              <div class="col-md-9 col-lg-10">
                <div class="logo" data-toggle="tooltip" title="Allez à la page d'accueil!" style="width:20px"><a href="home.php"><img src="images/logo.png" style="width:120px;height:60px" alt="#" /></a></div>
                    ...
                    <div class="menu" style="background-color: C9FFE5;">
                      <ul class="clearfix nav nav-tabs">
                        ...
                        <div class="dropdown-menu">
                         ...
                         <li class="nav-item dropdown">
                           <a class="nav-link active dropdown-toggle" style="background-color:LightBlue" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="#">Désactiver compte</a>
                         <div class="dropdown-menu">
        ...
        <h2>Désactiver le compte</h2>
          ...
          <div class="form-group col-md-8">
      		...
      		<div class="form-group">
      			<button type="submit" class="btn btn-danger" name="delete">Désactiver</button>
      		</div>
      	</form>
      </div>
