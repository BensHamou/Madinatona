...
<head>
  <meta charset="utf-8" />
  <title>MadinaTech - Rechercher utilisateur</title>
...
<ul>
  ...
  <li><a class="active" href="consultationuser.php">Désactiver un profile (Chercher)</a></li>
...
<body>
  ...
  if(isset($_POST['supprimer'])){
    ...
    $mail ->IsHTML(true);
    $mail ->Username = "milasidhem43@gmail.com";
